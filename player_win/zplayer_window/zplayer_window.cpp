// zplayer_window.cpp : 定义应用程序的入口点。
//

#include "framework.h"
#include "zplayer_window.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_ZPLAYERWINDOW, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ZPLAYERWINDOW));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ZPLAYERWINDOW));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)GetStockObject(NULL_BRUSH);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_ZPLAYERWINDOW);
...
void startPLay() {
	decodeThread = std::thread(DecodeThread);
    g_bExit = false;
}
